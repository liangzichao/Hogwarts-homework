...
#         self.driver.find_element( By.CSS_SELECTOR,".qui_inputText ww_inputText").send_keys("lalal")
#
#         # 点击下拉框
#
#
#         self.driver.find_element( By.XPATH, '//a[@class="qui_btn ww_btn ww_btn_Dropdown js_toggle_party_list"]')
#         # 输入点击保存
#         click_save = By.XPATH, "//a[@class='qui_btn ww_btn']"
#         self.driver.find_element(By.XPATH,"//a[@class='qui_btn ww_btn']")
#
